    ...
    <div className="d-flex" style={{ height: "100vh", backgroundColor: "#edf7f9" }}>
      <Container fluid className="p-4 main-content" style={{ marginLeft: "0px", width: "calc(100% - 0px)" }}>
        ...
        <div className="status-labels" style={{ display: "flex", justifyContent: "space-around", marginTop: "10px", marginBottom: "20px", gap: "15px", flexWrap: "wrap" }}>
          <Card style={{ flex: "1", minWidth: "150px", padding: "20px", display: "flex", flexDirection: "column", alignItems: "center", gap: "12px" }}>
            ...
            <span style={{ fontSize: "1.2rem", fontWeight: "700", textAlign: "center" }}>
              {orders.filter(order => order.currentStatus === "pending").length} orders
            </span>
          </Card>
          <Card style={{ flex: "1", minWidth: "150px", padding: "20px", display: "flex", flexDirection: "column", alignItems: "center", gap: "12px" }}>
            ...
            <span style={{ fontSize: "1.2rem", fontWeight: "700", textAlign: "center" }}>
              {orders.filter(order => order.currentStatus === "confirmed").length} orders
            </span>
          </Card>
          <Card style={{ flex: "1", minWidth: "150px", padding: "20px", display: "flex", flexDirection: "column", alignItems: "center", gap: "12px" }}>
            ...
            <span style={{ fontSize: "1.2rem", fontWeight: "700", textAlign: "center" }}>
              {orders.filter(order => order.currentStatus === "preparing").length} orders
            </span>
          </Card>
          <Card style={{ flex: "1", minWidth: "150px", padding: "20px", display: "flex", flexDirection: "column", alignItems: "center", gap: "12px" }}>
            ...
            <span style={{ fontSize: "1.2rem", fontWeight: "700", textAlign: "center" }}>
              {orders.filter(order => order.currentStatus === "pickedUp").length} orders
            </span>
          </Card>
          <Card style={{ flex: "1", minWidth: "150px", padding: "20px", display: "flex", flexDirection: "column", alignItems: "center", gap: "12px" }}>
            ...
            <span style={{ fontSize: "1.2rem", fontWeight: "700", textAlign: "center" }}>
              {orders.filter(order => order.currentStatus === "inTransit").length} orders
            </span>
          </Card>
          <Card style={{ flex: "1", minWidth: "150px", padding: "20px", display: "flex", flexDirection: "column", alignItems: "center", gap: "12px" }}>
          ...
          <Card style={{ flex: "1", minWidth: "150px", padding: "20px", display: "flex", flexDirection: "column", alignItems: "center", gap: "12px" }}>
            ...
            <span style={{ fontSize: "1.2rem", fontWeight: "700", textAlign: "center" }}>
              {orders.filter(order => order.currentStatus === "returned").length} orders
            </span>
          </Card>
        </div>
        ...
        <div style={{
          ...
          gap: "20px",
          marginTop: "20px",
          justifyContent: orders.length === 1 ? "flex-start" : "flex-start",
          flexWrap: "wrap",
              ...
              <Card key={idx} style={{ padding: "20px", textAlign: "left", display: "flex", flexDirection: "column", alignItems: "flex-start", width: "300px" }}>
                ...
                {order.assignedRider && (
                  <div style={{ display: "flex", alignItems: "center", gap: "10px", marginTop: "10px", width: "100%", backgroundColor: "#f0f0f0", padding: "10px", borderRadius: "6px" }}>
                    <img src={riderImage} alt={riders[order.assignedRider]?.name || "Rider"} style={{ width: "50px", height: "50px", borderRadius: "50%" }} />
                    <div>
                      <div style={{ fontWeight: "600" }}>{riders[order.assignedRider]?.name || "Unknown Rider"}</div>
